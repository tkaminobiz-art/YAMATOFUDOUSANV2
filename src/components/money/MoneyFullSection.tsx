...
const BUCKETS = [
  ...
  { no: "03", label: "土地代", amount: "500〜2,500", unit: "万円", pct: 35, color: "#7D4427", body: "奈良・京都で、現在27区画公開中(累計分譲実績90区画以上)。価格を抑えやすいエリアから利便性重視まで、ご希望に合わせてお選びいただけます。", yamato: "区画・エリアによる" },
...
function LoanAsFinancialTool() {
  ...
  const POINTS = [
    ...
    },
    {
      n: "02",
      title: "長く、借りられる。",
      body: "35年の長期返済が組めるのは、住居が「暮らしの基盤」だから。月々を抑えながら、家計全体を組める手段になります。",
    },
    {
      n: "03",
      title: "完済の先に、残る。",
      body: "返済の先に、土地と建物が残ります。老後の住居費が軽くなる、将来の家族に引き継げる。意味は2つです。",
    },
  ] as const;
      ...
      <div ref={ref} className="mx-auto max-w-[1100px] px-[var(--page-px)] scroll-in">
        ...
        <div className="space-y-3 md:space-y-4">
          ...
          <QItem no="07" q="FP(ファイナンシャルプランナー)って、どのような立場で相談に乗ってくれるのですか？" teaser="やまと社内ではなく、独立した立場の提携先FP事務所">
            ...
            <div className="px-5 md:px-6 py-4 md:py-5 border" style={{ background: "#FAF8F3", borderColor: "rgba(72,107,0,0.15)" }}>
              ...
              <p className="text-text-primary text-[13px] md:text-[14px] leading-[1.85]">
                社内には、住宅ローンアドバイザー資格保有者がおります(FPとは別)。複数の金融機関(大和信用金庫・奈良中央信用金庫・南都銀行・りそな銀行など)からご状況に合うものを一緒に整理します。
              </p>
            </div>
          </QItem>
          ...
          <QItem no="08" q="はじめての相談、何を持っていけばいいですか？" teaser="手ぶらでお越しいただけます。お電話またはフォームからご予約を">
            ...
            <div className="mt-12 pt-8 border-t border-text-primary/15">
              ...
              <p className="text-[12px] md:text-[13px] leading-[1.95] text-text-secondary mb-5 max-w-[760px]">
                ご相談から引き渡し後まで、3つのフェーズに分けてご案内します。お金のことは、各フェーズで都度整えていきます。
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-text-primary/10 border border-text-primary/15">
                {[
                  {
          ...
          <QItem no="10" q="お金の用語、わからない言葉が出てきたら？" teaser="住宅ローンの基本用語を、やさしく解説します">
            ...
            <p className="mt-4 text-[11px] md:text-[12px] leading-[1.85] text-text-secondary">
              ※ ご相談時に、用語の意味も含めて整理しながらお話しします。わからないまま進むことはありません。
            </p>
          </QItem>
        </div>
      </div>
