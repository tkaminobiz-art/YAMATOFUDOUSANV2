...
const MECHANISMS: readonly Mechanism[] = [
  {
    no: "01",
    body: "広告は、必要な分だけ使っています。テレビCMや大型広告は出さず、奈良・京都南部のご家族へSNSや物件サイトでお知らせしています。",
  },
  {
    no: "02",
    body: "専用の展示場は、建てていません。自社の分譲地に建てた家を、そのままモデルハウスにしています。その家は、いずれ販売します。",
  },
  {
    no: "03",
    body: "中間業者を、入れていません。土地・設計・施工・アフターを自社で一貫しています。",
  },
] as const;
