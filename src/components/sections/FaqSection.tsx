...
const FAQS = [
  {
    ...
    a: "建物本体と付帯工事までを含めた目安です。地盤改良費（最大150万円）と仲介手数料は当社が負担します。つなぎ融資は、当社の土地+建物セットなら原則発生しません(独自にお持ちの土地で建てる場合は別途ご相談)。別途になるのは、土地代・登記費用・引越し費用です。外構の基本工事は標準に含み、グレードアップ部分のみ別途お見積もりになります。",
  },
  {
    q: "この価格で、品質は大丈夫ですか？",
    a: "使う素材は、大手と同じです。クリナップ、TOTO、YKK AP、旭化成ヘーベルパワーボード。国内メーカーを標準で揃えています。価格の理由は、専用の展示場を持たず自社分譲地のモデルハウスで兼ねていること、設計から施工まで自社で進めていることにあります。",
  },
  {
    q: "土地を持っていません。土地探しもお願いできますか？",
    a: "はい。奈良・京都エリアで自社分譲の実績があります。土地と建物をまとめてご提案できるので、段取りを一本化できます。当社の土地+建物セットなら、つなぎ融資も発生しません(一般に30〜80万円分の節約)。",
  },
  {
    q: "住宅ローンの相談はできますか？",
