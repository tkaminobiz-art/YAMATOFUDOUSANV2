...
const FAQS = [
  {
    ...
    a: "建物本体＋付帯工事、すべて含んだ価格です。地盤改良費は当社が全額負担（最大150万円）、仲介手数料・つなぎ融資の負担もゼロです。含まれないのは、土地代・登記費用・引越し代のみです。",
  },
  {
    q: "この価格で、品質は大丈夫ですか？",
    a: "使っている素材は大手と同じです。クリナップ・TOTO・YKK AP・ニチハといった一流メーカーの製品を標準採用しています。展示場を持たず、広告費をかけず、設計から施工まで自社で行うことで、原価に近い価格でお届けしています。",
  },
  {
  ...
  },
  {
    ...
    a: "間取り・設備・素材は全邸フルオーダーです。お客様のライフスタイルに合わせて設計します。ただし構造上変更できない箇所（耐力壁の位置等）はご相談で決めます。",
  },
  {
    q: "打合せはどのくらいかかりますか？",
