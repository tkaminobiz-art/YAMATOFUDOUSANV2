...
const FAQS = [
  {
    ...
    a: "建物本体と付帯工事までを含めた目安です。地盤改良費（最大150万円）と仲介手数料は当社が負担します。つなぎ融資は土地の買い方によって発生しますが、土地と建物をまとめて進めることで条件次第で負担を抑えられる場合があります。別途になるのは、土地代・登記費用・引越し費用・外構工事です。",
  },
  {
    q: "この価格で、品質は大丈夫ですか？",
    a: "使う素材は、大手と同じです。クリナップ、TOTO、YKK AP、ニチハ。国内メーカーを標準で揃えています。価格の理由は、展示場や広告費を抑え、設計から施工まで自社で一貫していることにあります。",
  },
  {
