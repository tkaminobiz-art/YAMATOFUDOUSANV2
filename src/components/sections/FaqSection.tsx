...
const FAQS = [
  {
    ...
    a: "建物本体と付帯工事までを含めた目安です。地盤改良費（最大150万円）と仲介手数料は当社が負担します。つなぎ融資は、やまとの土地+建物セットなら原則発生しません(独自にお持ちの土地で建てる場合は別途ご相談)。別途になるのは、土地代・登記費用・引越し費用です。外構の基本工事は標準に含み、グレードアップ部分のみ別途お見積もりになります。",
  },
  {
    q: "この価格で、品質は大丈夫ですか？",
