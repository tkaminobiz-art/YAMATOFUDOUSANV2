...
const FAQS = [
  {
    ...
    a: "建物本体と付帯工事までを含めた目安です。地盤改良費（最大150万円）と仲介手数料は当社が負担します。つなぎ融資は土地の買い方によって発生しますが、土地と建物をまとめて進めることで条件次第で負担を抑えられる場合があります。別途になりやすいのは、土地代・登記費用・引越し費用などです。",
  },
  {
    q: "この価格で、品質は大丈夫ですか？",
    a: "使う素材は、大手と同等の水準を前提にしています。クリナップ、TOTO、YKK AP、ニチハなど国内メーカーを標準で揃えています。価格の理由は、展示場や広告費を抑え、設計から施工まで自社で一貫していることにあります。",
  },
  {
    q: "モデルハウスと標準仕様は本当に同じですか？",
    a: "同じ考え方で揃えています。モデルハウスでご覧になった設備を、オプションではなく標準仕様として揃える前提です。打ち合わせを重ねるほど価格が膨らむ、という形にはしません。",
  },
  {
  ...
  },
  {
    ...
    a: "はい。奈良・京都エリアで自社分譲の実績があります。土地と建物をまとめてご提案できるので、段取りを一本化しやすいのが特徴です。つなぎ融資についても、条件次第で負担を抑えられる場合があります。",
  },
  {
    q: "住宅ローンの相談はできますか？",
