...
const FAQS = [
  {
    ...
    a: "建物本体＋付帯工事、すべて含んだ価格です。地盤改良費は弊社が全額負担（最大150万円相当）、仲介手数料・つなぎ融資の負担もゼロです。含まれないのは、土地代・登記費用・引越し代のみです。",
  },
  {
    q: "安いのは、手抜きではないですか？",
  ...
  },
  {
    ...
    a: "地盤保証20年、しろあり保証10年がついています。建てた後も、電話一本で駆けつけます。引渡し後の関係を大切にしているのが、やまと不動産の特徴です。",
  },
  {
    q: "土地を持っていません。土地探しもお願いできますか？",
    a: "できます。弊社は土地の分譲実績が90区画以上あり、奈良・京都エリアで自社保有の分譲地をご紹介できます。土地と建物をセットで提供するため、つなぎ融資の負担もかかりません。",
  },
  {
    q: "住宅ローンの相談はできますか？",
