...
const FLOW_STEPS = [
  ...
  },
  {
    num: "02",
    title: "土地探し",
    desc: "九十区画以上の自社分譲地から、あなたに合う土地をお探しいたします。",
    duration: "1〜2週間",
  },
  {
    num: "03",
    title: "プラン・見積もり",
    desc: "ご予算の範囲で、間取りと仕様をご提案。価格は、最後まで動きません。",
    duration: "2〜3週間",
  },
  {
    num: "04",
    title: "ご契約",
    desc: "ご納得のうえで、ご契約。そこから先、価格は動きません。",
    duration: "1日",
  },
  {
    num: "05",
    title: "詳細打合せ",
    desc: "間取り・設備・素材を決定。自由設計だから、細部まで、ご家族らしく。",
    duration: "1〜2ヶ月",
  },
  {
    num: "06",
  ...
  },
  {
    num: "09",
    title: "お引渡し",
    desc: "お引き渡しの日から、本当のお付き合いがはじまります。半年、一年、五年——そのたびに、私どもからお伺いいたします。",
    duration: "半日",
  },
  {
    num: "10",
    title: "アフターフォロー",
    desc: "半年、一年、二年、五年、十年の定期点検。お電話ひとつで、すぐにお伺いいたします。",
    duration: "ずっと",
  },
] as const;
      ...
      >
        <div className="mb-10 md:mb-14 max-w-[640px]">
          ...
          <p className="text-text-secondary text-[clamp(15px,1.1vw,17px)] leading-relaxed">
            土地探しからお引き渡し、その先のお手入れまで。すべて、当社が承ります。
          </p>
        </div>
