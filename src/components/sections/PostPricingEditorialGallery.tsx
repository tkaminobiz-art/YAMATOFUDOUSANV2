...
const ROW_A = [
  { src: "/images/works/case3-living.webp", alt: "施工事例 リビング" },
  { src: "/images/works/case1-kitchen.webp", alt: "施工事例 キッチン" },
  { src: "/images/works/works-03.webp", alt: "施工事例 外観イメージ" },
  { src: "/images/works/case2-ext.webp", alt: "施工事例 外観" },
  { src: "/images/fv/hero-02-exterior-sakyo.webp", alt: "左京モデル 外観" },
  { src: "/images/works/case3-kitchen.webp", alt: "施工事例 キッチン" },
] as const;

const ROW_B = [
  { src: "/images/works/works-01.webp", alt: "施工事例" },
  { src: "/images/works/case1-ext.webp", alt: "施工事例 外観" },
  { src: "/images/works/case3-entrance.webp", alt: "施工事例 玄関" },
  { src: "/images/works/works-05.webp", alt: "施工事例" },
