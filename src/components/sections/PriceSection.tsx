...
export default function PriceSection() {
  return (
    <section id="product" className="bg-bg-secondary py-16 md:py-20 lg:py-24">
      <div className="max-w-5xl mx-auto px-5 md:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          <div className="flex items-baseline justify-center gap-2">
            <span
              className="text-text-primary font-bold text-6xl md:text-7xl lg:text-8xl tracking-tight"
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="border-b-2 border-main">
                ...
                <th className="py-3 px-4 text-center">
                  <span className="text-main font-bold text-lg">花</span>
            ...
            <tbody>
              {ROWS.map((row, i) => (
                <tr
                  key={row.label}
                  className={`border-b border-border ${i % 2 === 0 ? "bg-white" : "bg-bg-secondary"}`}
                >
                  <td className="py-3 px-4 text-text-secondary font-medium text-xs">
                    {row.label}
                  </td>
