...
const CHAPTERS: Chapter[] = [
  {
    ...
    title: "契約前の不透明を、ゼロに。",
    intro:
      "仲介や別会社を挟まず、最初から費用の全体を、お見せいたします。",
    zeros: [
      {
        num: "01",
        title: "仲介手数料",
        desc: "自社分譲でございますので、仲介会社を挟みません。数十万から百万円単位の仲介手数料は、いただきません。",
        Icon: Handshake,
      },
      {
        num: "02",
        title: "つなぎ融資の負担",
        desc: "土地と建物をまとめてご用意いたしますので、つなぎ融資の金利負担はかかりません。",
        Icon: Banknote,
      },
      {
        num: "03",
        title: "地盤改良費",
        desc: "最大百五十万円かかる地盤改良費は、当社が全額負担いたします。お客様のお見積もりには、一切含みません。",
        Icon: Layers,
      },
    ],
  },
  {
    ...
    title: "建築中の追加請求を、ゼロに。",
    intro:
      "現場の都合で、お値段が上がることは、一切ございません。",
    zeros: [
      {
        num: "04",
        title: "余計な搬入費用",
        desc: "工事車両がスムーズに入れる分譲地を整えておりますので、追加の資材搬入コストはかかりません。",
        Icon: Truck,
      },
      {
        num: "05",
        title: "工事車両の駐車場代",
        desc: "自社分譲地だからこそ、工事車両の駐車スペースも確保できます。お客様に余計なご負担を、おかけすることはございません。",
        Icon: Car,
      },
      {
        num: "06",
        title: "不透明な追加費用",
        desc: "お見積もりに載っていない費用が、あとから上乗せされることは、ございません。お見積もりは、一枚ですべてお分かりいただけます。",
        Icon: FileCheck,
      },
    ],
  },
  {
    ...
    title: "建築後のズレを、ゼロに。",
    intro:
      "お打ち合わせで決めた内容は、最後まで、そのままお届けいたします。",
    zeros: [
      {
        num: "07",
        title: "打合せ後の追加費用",
        desc: "はじめから、すべて標準仕様。お打ち合わせを重ねても、お値段が上がっていくことはございません。",
        Icon: MessageCircle,
      },
      {
        num: "08",
        title: "モデルハウスとのギャップ",
        desc: "モデルハウスでご覧になった設備を、オプションではなく、すべて標準仕様でご用意しております。",
        Icon: Home,
      },
    ],
  },
      ...
      <div ref={sectionRef} className="relative mx-auto max-w-[1400px] px-[var(--page-px)]">
        <div className="scroll-in">
          <SectionHeaderCentered
            ...
            ghostText="ZERO"
            lead="他社では当たり前にかかる費用が、当社ではゼロでございます。家づくりの時間軸——ご契約前、建築中、その後——に沿って、お約束を並べます。"
            theme="dark"
          />
        </div>
