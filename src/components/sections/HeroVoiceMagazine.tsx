...
const VOICES: Voice[] = [
  {
    ...
    photoAlt: "奈良市 I様邸 — ずっと思い描いていた土地に建てた家",
    hero1: "夢に描いた、",
    hero2: "その土地に。",
    heroColor: "amber",
    subText: "ここに家を建てたいと夫婦で話していた土地に、やまと不動産の旗が立っていて、問い合わせたのがきっかけです。",
    attribution: "奈良市 I様邸",
    voiceId: "202180",
  },
  {
    ...
    hero2: "ここに着いた。",
    heroColor: "oak",
    subText: "2年近く土地を探していたのですが、なかなか思うような土地が見つかりませんでした。そしてやっと見つけた納得のいく土地が、やまと不動産の分譲地でした。",
    attribution: "奈良市 M様邸",
    voiceId: "199927",
  },
  {
    ...
    photoAlt: "斑鳩町 I様邸 — 標準仕様のまま理想を叶えた家",
    hero1: "標準のままで、",
    hero2: "理想に届いた。",
    heroColor: "ink",
    subText: "他社様の標準仕様はグレードが低く、私たちのしたいお家作りには適していませんでした。やまとさんは標準仕様が元々すごく良かったのが決め手です。",
    attribution: "斑鳩町 I様邸",
    voiceId: "279070",
  },
  {
    ...
    photoAlt: "生駒市 I様邸 — 年末に出会えた家",
    hero1: "諦めかけた、",
    hero2: "その年末に。",
    heroColor: "amber",
    subText: "新築を建てようと土地探しや工務店選びでなかなか良い所がなく、一度諦めようと思っていた時に、何気なくネットで見つけたのがきっかけでした。",
    attribution: "生駒市 I様邸",
    voiceId: "216803",
  },
  {
    ...
    photoAlt: "奈良市 I様邸 — 追加のいらない家",
    hero1: "必要なものは、",
    hero2: "すべて、ここに。",
    heroColor: "ink",
    subText: "探していた土地にやまと不動産の看板が立っていて、モデルルームの見学にいったのがきっかけでした。行ってみると、まさか小中学校の後輩が担当でした。",
    attribution: "奈良市 I様邸",
    voiceId: "208787",
  },
  {
    ...
    photoAlt: "木津川市 H様邸 — 無理のない家づくりで建てた家",
    hero1: "無理のない、",
    hero2: "私たちの家。",
    heroColor: "forest",
    subText: "探していた場所で予算に収まる土地を売られていて、家の金額も「花シリーズ」「風シリーズ」の2種類用意されていて、予算的・デザイン的に合っていました。",
  ...
  },
  {
    ...
    photoAlt: "奈良市 M様邸 — 信頼できる担当者と建てた家",
    hero1: "この人となら、",
    hero2: "建てられる。",
    heroColor: "amber",
    subText: "なにげなく立ち寄ったモデルルームで、西口さん（担当者）の軽快なトークに魅了され、一気に購入まで。約半年間、図面やサンプルの打ち合わせをし、本当に誠実に対応していただきました。",
    attribution: "奈良市 M様邸",
    voiceId: "225612",
  },
  {
    ...
    photoAlt: "奈良市 O様邸 — 住まいのすぐ近くで出会えた家",
    hero1: "最後の年末に、",
    hero2: "出会えた家。",
    heroColor: "oak",
    subText: "土地が見つからず、新築を1度諦めていた中、年末に偶然ネットで土地を見つけて、偶然賃貸で住んでいる近所にやまと不動産があったので、とりあえず話を聞いてみよう、がはじまりです。",
    attribution: "奈良市 O様邸",
    voiceId: "242157",
  },
  {
    ...
    photoAlt: "斑鳩町 K様邸 — 小さな願いに寄り添ってくれた家",
    hero1: "どんな願いにも、",
    hero2: "耳を傾けてくれた。",
    heroColor: "forest",
    subText: "標準グレードが非常に高く、部屋の形を色々と考えてくれ、間取りの自由がとてもききました。営業、設計の方を始め、親身になって相談にのっていただけました。",
    attribution: "斑鳩町 K様邸",
    voiceId: "239226",
  },
];
