...
/*
  20セクション構成（Phase 1リファクタ / 2026-04-16・FounderQuote統合）
  ...
  【④ 実現可能性 — 払えるのか】
  6. Price            料金目安（2,480万〜バーン）
  7. MoneyTalk(新)    お金の話、まず気軽に（FP・つなぎ融資なし）

  【⑤ 土地の安心 — 最初の悩み】
  8. Lots(前倒し)     まず、土地の話から（土地＋建物セット提案）

  【⑥ 商品の魅力】
  9. FreedomOfDesign 完全自由設計
  10. Standard        標準仕様

  【⑦ 信頼の裏付け】
  11. Quality         品質
  12. Guarantee       保証
  13. StaffStory      19人の職人
