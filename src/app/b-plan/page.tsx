      ...
      <main>
        <section className="relative min-h-screen overflow-hidden text-white">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(0,0,0,0.74) 0%, rgba(0,0,0,0.45) 42%, rgba(0,0,0,0.2) 100%)",
            }}
          />
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.18) 40%, rgba(0,0,0,0.78) 100%)",
            }}
          />
          <BlueprintLayer dark />
          <div className="relative z-10 flex min-h-screen items-end px-5 pb-20 pt-24 md:px-10 md:pb-24 xl:px-14">
            <div className="w-full">
              <div className="max-w-[1080px]">
                <Eyebrow light>total cost first</Eyebrow>
                <h1 className="hero-copy font-medium tracking-[0.01em]" style={{ fontFamily: "var(--font-shippori)" }}>
                  <span className="hidden whitespace-nowrap md:block">大手品質の注文住宅を</span>
                  <span className="hidden whitespace-nowrap md:block">土地込みの現実価格で</span>
                  <span className="block whitespace-nowrap md:hidden">大手品質の注文住宅を</span>
                  <span className="block whitespace-nowrap md:hidden">土地込みの</span>
                  <span className="block whitespace-nowrap md:hidden">現実価格で</span>
                </h1>
                <p className="mt-7 max-w-[690px] text-[15px] font-bold leading-[2.05] text-white/84 md:text-[18px]">
                  同品質の素材・装備を備えながら、
                  <br className="hidden md:block" />
                  建物・土地・諸費用まで見える家づくり。
                </p>
                <p className="mt-5 flex flex-wrap items-baseline gap-x-3 gap-y-1 text-white">
                  <span className="text-[13px] font-bold tracking-[0.12em] text-white/68">コミコミ</span>
                  <span className="text-[clamp(36px,5.2vw,70px)] font-light leading-none" style={{ fontFamily: "var(--font-oswald)" }}>2,280</span>
                  <span className="text-[18px] font-bold md:text-[24px]">万円から</span>
                </p>
                <p className="mt-3 text-[11px] font-bold leading-[1.7] text-white/58 md:text-[12px]">
                  ※一部登記費用などは別途発生します
                </p>
                <Cta dark />
              </div>
              <div className="mt-12 grid max-w-[860px] grid-cols-3 border border-white/42 bg-white/12 backdrop-blur">
                {heroStats.map((item) => (
                  <div key={item.title} className="border-r border-white/26 p-4 last:border-r-0 md:p-5">
                    <p className="text-[10px] font-bold tracking-[0.2em] text-white/48 md:text-[11px]" style={{ fontFamily: "var(--font-inter)" }}>
                      {item.number}
                    </p>
                    <p className="mt-3 whitespace-nowrap text-[clamp(19px,5vw,32px)] font-medium leading-none" style={{ fontFamily: "var(--font-shippori)" }}>
                      {item.title}
                    </p>
                    <p className="mt-4 text-[10px] font-bold leading-[1.55] text-white/72 md:text-[12px]">
                      {item.lead}
                    </p>
                  </div>
                ))}
        ...
        <section id="payment-cases" className="payment-section relative scroll-mt-24 overflow-hidden px-5 py-[74px] md:scroll-mt-28 md:px-10 lg:py-[120px] xl:px-14">
          <div className="payment-bg-wash absolute inset-0" aria-hidden="true" />
          <BlueprintLayer />
          <ReasonReveal className="relative z-10 mx-auto max-w-[1480px]">
            ...
            <div className="mt-[68px]">
              <div className="payment-slider -mx-5 flex snap-x snap-mandatory gap-5 overflow-x-auto px-5 pb-8 md:-mx-10 md:px-10 lg:mx-0 lg:gap-7 lg:px-0">
                {paymentCases.map((item, index) => (
                  <article
                    key={item.no}
                    className={`payment-card payment-card-${index + 1} relative min-w-[min(920px,calc(100vw-58px))] snap-center overflow-hidden rounded-[8px] border border-white/58 bg-white/[0.10] text-[#181714] shadow-[0_46px_130px_-70px_rgba(24,23,20,0.78),inset_0_1px_0_rgba(255,255,255,0.82),inset_0_-1px_0_rgba(255,255,255,0.14)] backdrop-blur-[38px] lg:min-w-[900px] xl:min-w-[980px]`}
                    data-case-card
                  >
                    <div className="payment-card-inner">
                      <div className="p-6 md:p-9 lg:p-10">
                        <div className="flex items-start justify-between gap-5">
                          <div>
                            <p className="payment-case-chip inline-flex border px-3 py-2 text-[11px] font-bold uppercase tracking-[0.18em] backdrop-blur-[26px]">{item.no}</p>
                            <p className="payment-case-meta mt-3 text-[12px] font-bold leading-[1.7] tracking-[0.08em]">{item.customer}</p>
                            <p className="payment-concern mt-3 text-[14px] font-bold leading-[1.8]">{item.concern}</p>
                          </div>
                          <div className="payment-monthly-box min-w-[138px] rounded-[8px] border px-3 py-3 text-right backdrop-blur-[28px] md:min-w-[168px] md:px-4">
                            <p className="text-[10px] font-bold uppercase tracking-[0.18em]">月々返済</p>
                            <p className="payment-monthly-number mt-1 text-[34px] font-light leading-none md:text-[50px]" style={{ fontFamily: "var(--font-oswald)" }}>
                              {item.monthly}
                            </p>
                            <p className="mt-1 text-[12px] font-bold">円 / 月</p>
                          </div>
                        </div>

                        <h3 className="payment-case-headline mt-[42px] max-w-[760px] text-[25px] font-medium leading-[1.5] md:text-[32px]" style={{ fontFamily: "var(--font-shippori)" }}>
                          {item.headline}
                        </h3>

                        <div className="payment-fact-grid mt-[42px] grid grid-cols-2 gap-px border backdrop-blur-[28px] md:grid-cols-3">
                          {[
                            ["家族", item.family],
                            ["年収", item.income],
                            ["プラン", item.plan],
                            ...
                            <div key={label} className="p-4 backdrop-blur-[28px]">
                              <p className="text-[10px] font-bold uppercase tracking-[0.16em]">{label}</p>
                              <p className="mt-2 text-[14px] font-bold leading-[1.6]">{value}</p>
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="mt-5 flex flex-wrap gap-2">
                          {item.breakdown.map((part) => (
                            <span key={part} className="payment-breakdown-chip border px-3 py-2 text-[12px] font-bold backdrop-blur-[24px]">
                              {part}
                            </span>
                          ))}
                        </div>
                      </div>
                      <figure className="payment-card-figure">
                        <Image src={item.image} alt={`${item.no}の支払いケース`} fill className="object-cover" sizes="(min-width: 1024px) 24vw, 100vw" />
                        <div className="payment-image-glow absolute inset-0 backdrop-blur-[0.2px]" />
                      </figure>
                    </div>
                  </article>
                ))}
          ...
          <div className="mx-auto max-w-[1380px]">
            <div className="mb-12 max-w-[1280px] md:mb-14">
              <div>
                ...
                <h2 className="text-[clamp(30px,3.35vw,54px)] font-medium leading-[1.24] tracking-[0.03em] md:whitespace-nowrap" style={{ fontFamily: "var(--font-shippori)" }}>
        ...
        <section className="relative overflow-hidden px-5 py-20 md:px-10 lg:py-28 xl:px-14" style={{ backgroundColor: P.smoke }}>
          ...
          <div className="relative mx-auto grid max-w-[1380px] gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div>
              ...
              <h2 className="text-[clamp(31px,5vw,68px)] font-medium leading-[1.18]" style={{ fontFamily: "var(--font-shippori)" }}>
                あとから出てくる金額で、
                <br />
                がっかりしてほしくない。
              </h2>
            ...
            <div className="grid grid-cols-2 gap-px border md:grid-cols-3" style={{ borderColor: P.line, backgroundColor: P.line }}>
              {zeroItems.map((item) => (
                <div key={item} className="bg-[#fffdfa] p-5">
                  <p className="text-[32px] font-bold leading-none" style={{ color: P.red }}>要確認</p>
                  <p className="mt-5 text-[15px] font-bold">{item}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="action" className="relative scroll-mt-24 overflow-hidden px-5 py-20 md:scroll-mt-28 md:px-10 lg:py-28 xl:px-14" style={{ backgroundColor: P.white }}>
          ...
          <div className="relative mx-auto grid max-w-[1280px] gap-10 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
            ...
            <div className="grid gap-px border" style={{ borderColor: P.line, backgroundColor: P.line }}>
              {[
                ["土地込み総額を出す", "LINEで目安を出す", LINE_ADD_FRIEND_URL, true, <MessageCircle key="line" className="h-5 w-5" />],
                ["土地と建物を同時に見る", "進め方を確認", "/contact", false, <FileText key="file" className="h-5 w-5" />],
                ["モデルハウスで見る", "標準仕様を実物で確認", "/reserve", false, <House key="house" className="h-5 w-5" />],
              ].map(([title, text, href, external, icon], index) => (
                <a
                  key={String(title)}
                  href={String(href)}
                  target={external ? "_blank" : undefined}
                  rel={external ? "noopener noreferrer" : undefined}
                  className="group grid grid-cols-[1fr_auto] items-center gap-5 bg-[#fffdfa] p-6 transition hover:bg-[#f2eadf] md:p-8"
                  style={index === 0 ? { backgroundColor: P.green, color: P.white } : undefined}
                >
                  <span>
                    <span className="flex items-center gap-3 text-[24px] font-medium" style={{ fontFamily: "var(--font-shippori)" }}>
                      {icon}
                      {String(title)}
                    </span>
                    <span className="mt-2 block text-[13px] font-bold opacity-68">{String(text)}</span>
                  </span>
