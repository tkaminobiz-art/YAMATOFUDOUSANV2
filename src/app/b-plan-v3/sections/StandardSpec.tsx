  ...
  return (
    <SectionShell surface="ivory" aria-label="標準仕様｜見学した安心を、そのまま標準に。">
      <div className="mx-auto max-w-[1080px]">
        ...
        {/* 直書き<br>（hidden md:block）を廃止＝SP/PCで別リズムになる非セマンティック改行を撤去。
            3センテンスを独立段落＋measure(40em)で統一（中央の設備列挙はPhase2で3分類カードへ集約予定）。 */}
        <div className="t-body mt-6 max-w-[40em] space-y-2.5 text-ink-muted">
          <p>「これはオプションです」と後から増えるのではなく、家族が長く安心して暮らすために必要な仕様を、はじめから標準に。</p>
          <p>耐震等級3に対応する構造、制震ダンパー、外壁、キッチン、浴室、洗面、トイレ、窓、玄関、保証まで。</p>
          <p>見た目だけではなく、住んでからの安心まで含めて整えています。</p>
        </div>
