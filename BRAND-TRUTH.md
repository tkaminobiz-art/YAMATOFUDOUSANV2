...
### 4.4 地盤改良費 ─「一切かからない」と断定で訴求

やまと不動産では、**地盤改良費は一切かからない**。  
ユーザーが「見積もり後に追加されるのでは」と不安になりやすい費用として、03 / why possible では強く扱ってよい。

**How to apply:**
- 「地盤改良費はかかりません」「地盤改良費は一切かかりません」を主軸に
- つなぎ融資と並べて、後から出やすい不安を先に消す
- 価格訴求ではなく「総額の見通しが崩れにくい」意味へ接続する
- この項目は 4.6 の「一切ない」禁止ルールの例外。断定してよい
...
下部 overlay には Track Record 4 指標 (600棟・150区画・50組・14年) を継続表示。
